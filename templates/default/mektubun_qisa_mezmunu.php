    ...
    <form class="form-horizontal">
        <div class="form-body">
            <div class="form-group">
                <label class="control-label col-md-4"> Məzmun</label>
                <div class="col-md-6">
                    <input class="form-control" vezife="ad" placeholder="Məzmun">
                </div>
            </div>
        </div>
    </form>
...
<script>
    ...
    $(bosh_modal + " button[vezife='testiqle']").click(function()
    {
        ...
        {
            modal_loading(1,MN);
            $.post(proBundle + "includes/umumi/mektubun_qisa_mezmunu.php",
                {
                    'ad' : ad
                },
                function(netice)
                {
                    modal_loading(0,MN);
                    if(netice=="movcuddur") {
                        errorModal("Bu adda sənədin məzmunu daha öncə yaradılıb!",3000,true);
                    } else {
