    ...
    <div class="row">
        <div class="col-md-10">
            <table class="table table-striped table-bordered table-advance table-hover" id="contact_types">
                ...
                <tr>
                    <th>№</th>
                    <th style="width: 200px;">Məktubun tipi</th>
...
<script type="text/javascript">
    ...
    $('#contact_types>tbody').on("click",".blue",function(e)
    {
        ...
        else
        {
            ...
            $.post("prodoc/ajax/msk/mektubun_tipi_rol.php", {'tid':tid, 'tip' : tip, 'rollar':rollar},function(netice)
            {
                if(netice == "error")
                {
    ...
    $('#contact_types>tbody').on("click",".red",function(e) {
        ...
        swals({
            ...
            function () {
                $.post("prodoc/ajax/msk/mektubun_tipi_rol.php", {'tid':idsi,'ne':"sil"}).done(function (netice) {
