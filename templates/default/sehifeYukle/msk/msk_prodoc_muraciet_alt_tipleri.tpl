    ...
    <div class="row">
        <div class="col-md-8">
            <table class="table table-striped table-bordered table-advance table-hover" id="contact_types">
                ...
                <tr>
                    <th>№</th>
                    <th>Müraciətin alt tipləri</th>
                    <th style="width: 200px;">Müraciətin tipləri</th>
                    $theadElements$
                </tr>
                </thead>
...
<script type="text/javascript">
    ...
    $('#contact_types>tbody').on("click",".blue",function(e)
    {
        ...
        {
            $.post("prodoc/ajax/msk/msk_prodoc_muraciet_alt_tipleri.php", {'tid':tid,'ad':ad, "fildType":fildType},function(netice)
            {
                if(netice == "error")
                {
    ...
    $('#contact_types>tbody').on("click",".red",function(e)
    {
        ...
        swals({
            ...
            function(){
                $.post("prodoc/ajax/msk/msk_prodoc_muraciet_alt_tipleri.php", {'tid':idsi,'ne':"sil"}).done(function(netice)
                {
