	...
	<div class="row">
		<div class="col-md-8">
			<table class="table table-striped table-bordered table-advance table-hover" id="contact_types">
				...
				<tr>
					<th>№</th>
					<th>Şöbələrin indeksi</th>
					<th style="width: 200px;">Şöbə</th>
					$theadElements$
				</tr>
				</thead>
...
<script type="text/javascript">
	...
	$('#contact_types>tbody').on("click",".blue",function(e)
	{
		...
		{
			$.post("prodoc/ajax/msk/msk_prodoc_shobelerin_indeksleri.php", {'tid':tid,'ad':ad, "fildType":fildType},function(netice)
			{
				if(netice == "error")
				{
	...
	$('#contact_types>tbody').on("click",".red",function(e)
	{
		...
		swals({
			...
			function(){
				$.post("prodoc/ajax/msk/msk_prodoc_shobelerin_indeksleri.php", {'tid':idsi,'ne':"sil"}).done(function(netice)
				{
